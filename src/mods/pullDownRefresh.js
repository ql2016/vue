...
(function(global, factory) {
  ...
  var _defaults = {
    ...
    instructionsPullToRefresh: '<div class="load-png"></div>',//下拉刷新
    instructionsReleaseToRefresh: '<div class="load-png"></div>',//释放更新
    instructionsRefreshing: '<div class="load-gif">',//正在刷新
    refreshTimeout: 500,
  ...
  var _ptr = {
    ...
    onReset: function onReset(handler) {
      ...
      setTimeout(function() {
        ...
        handler.refreshEnd&&handler.refreshEnd();
  ...
  function _setupEvents() {
    ...
    function _onTouchEnd() {
      ...
      if (_shared.state === 'releasing' && _shared.distResisted > _el.distThreshold) {
        ...
        _el.refreshStart&&_el.refreshStart();
      } else {
        if (_shared.state === 'refreshing') {
          return;
        }
